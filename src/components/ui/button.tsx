...
const buttonVariants = cva(
  [
    "inline-flex items-center justify-center gap-1.5 whitespace-nowrap rounded-[var(--app-radius-sm)] border text-sm font-medium transition-all outline-none select-none",
