  ...
  ({ className, ...props }, ref) => {
    return (
      <textarea
        ...
        data-slot="textarea"
        className={cn(
          "flex min-h-[104px] w-full rounded-[var(--radius-md)] border border-slate-200 bg-white px-3 py-2 text-sm text-slate-950 shadow-sm outline-none transition-all placeholder:text-slate-400",
